...
const {userid}=useParams()
    return (
        <>
           <div class="mx-auto right-0 mt-2 w-screen ">
                <div class="bg-white rounded overflow-hidden shadow-lg">
                    <div class="text-center p-6 bg-yellow-900 border-b h-screen">
                    ...
                    <p class="pt-2 text-lg font-semibold text-gray-50">{userid}</p>
